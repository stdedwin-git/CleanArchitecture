using contractsAlias = HR.LeaveManagement.MVC.Contracts;
...
{
    public class AuthenticationService : BaseHttpService, contractsAlias.IAuthenticationService
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private JwtSecurityTokenHandler _tokenHandler;
        private readonly IMapper _mapper;

        public AuthenticationService(contractsAlias.ILocalStorageService localStorage, IClient client, IHttpContextAccessor httpContextAccessor, IMapper mapper) : base(localStorage, client)
        {
